...
// async function generateAndWriteBatch(csvWriter, startIndex, endIndex, columns, additionalColumns) {
//   const records = [];
...
//   console.log(`Batch ${startIndex / (endIndex - startIndex) + 1} generated`);
// }
...
//     await generateAndWriteBatch(csvWriter, i, endIndex, columns, additionalColumns);
//   }

//   console.log(`CSV file ${outputPath} written successfully with ${numRows} rows.`);
// }
// function processCsvFile(filename, columns) {
//   let lineNo = 1;
//   let skippedLines = 0;
...
// function generateFromExistingCsv(inputFile, outputFile = 'output.csv', columns) {
//   const csvWriter = createCsvWriter({
//     path: outputFile,
...
//         .then(() => console.log(`New CSV file ${outputFile} generated successfully.`))
